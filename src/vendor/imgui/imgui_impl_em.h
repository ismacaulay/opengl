// dear imgui: Platform Binding for emscripten inputs
...
IMGUI_IMPL_API bool     ImGui_ImplEmscripten_InitForOpenGL();
IMGUI_IMPL_API bool     ImGui_ImplEmscripten_InitForVulkan();
IMGUI_IMPL_API void     ImGui_ImplEmscripten_Shutdown();
IMGUI_IMPL_API void     ImGui_ImplEmscripten_NewFrame();
IMGUI_IMPL_API bool     ImGui_ImplEmscripten_ProcessEvent();
